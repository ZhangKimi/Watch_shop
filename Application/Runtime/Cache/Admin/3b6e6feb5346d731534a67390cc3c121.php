                        ...
                        <div class="ibox-content">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
								...
								<?php if(is_array($info)): foreach($info as $key=>$value): ?><tr class="gradeX">
									...
									<!-- 	<td>
											<a href="/watch_shop/index.php/Admin/Type/del?id=<?php echo ($value['id']); ?>">删除</a> | 
											<a href="/watch_shop/index.php/Admin/Type/edit?id=<?php echo ($value['id']); ?>">编辑</a> |
											<a href = "/watch_shop/index.php/Admin/Typeadd/index?pid=<?php echo ($value['pid']); ?>&path=<?php echo ($value['path']); ?>&name=<?php echo ($value['name']); ?>" target="_self">添加子类别</a>
										</td> -->
