                        ...
                        <div class="ibox-content">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
								...
								<?php if(is_array($info)): foreach($info as $key=>$value): ?><tr class="gradeX">
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tr" id="del<?php echo ($vo["parid"]); ?>,<?php echo ($vo["pid"]); ?>">
										...
										<td align="center">
								<!-- 	<a href="<?php echo U('Typepdel/del',array('pid'=>$vo['pid']));?>" target="_self" onFocus="this.blur()" class="add" onclick="return confirm('你确定删除吗？')">删除</a> -->
            ...
            $("a[tpl]").click(function () {
                ...
                swal({
                    ...
                    if(isConfirm){
                        // swal(id,"success");
                        $.ajax({
                            url: "/watch_shop/index.php/Admin/typepdel/del",
                            type: 'GET',
                            dataType: 'text',
                            data: {id: id},
