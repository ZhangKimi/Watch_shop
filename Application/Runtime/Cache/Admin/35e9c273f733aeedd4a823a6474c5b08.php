...
<head>
    ...
    <title>Luxury Watches - 品牌添加</title>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Luxury Watches - 品牌添加</h5>
                    </div>
                    <div class="ibox-content">
                        <form  action='/watch_shop/index.php/Admin/Brandadd/insert' target="_self" method="post" class="form-horizontal">
