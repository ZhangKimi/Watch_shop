...
<html>
    <head>
        ...
        <title>Luxury Watches - 会员列表</title>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <?php if(is_array($result)): foreach($result as $key=>$value): ?><tr class="gradeX">
                                            ...
                                            <td><a href="/watch_shop/index.php/Admin/Userlist/details?id=<?php echo ($value["uid"]); ?>&user=<?php echo ($value["username"]); ?>" target="_self">详细资料</a></td>
