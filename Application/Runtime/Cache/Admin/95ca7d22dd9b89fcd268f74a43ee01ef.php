...
<html>
    <head>
        ...
        <title>Luxury Watches - 会员资料编辑</title>
                        ...
                        <div class="ibox-content">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <?php if(is_array($result)): foreach($result as $key=>$value): ?><tr class="gradeX">
	                                        <td><?php echo ($value["uid"]); ?></td>
                                            <td><?php echo ($value["username"]); ?></td>
                                            <?php if(($value["stat"]) == "1"): ?><td>正常</td><?php endif; ?>
                                            <?php if(($value["stat"]) == "2"): ?><td>待激活</td><?php endif; ?>
                                            <?php if(($value["stat"]) == "3"): ?><td>冻结</td><?php endif; ?>
                                            <?php if(($value["stat"]) == "0"): ?><td>禁用</td><?php endif; ?>
                                            <td class="center"><?php echo (date("Y-m-d H:i:s",$value["registtime"])); ?></td>
                                            <td>
                                                <a href="/watch_shop/index.php/Admin/Useredit/edit?id=<?php echo ($value["uid"]); ?>" title="编辑该用户" target="_self">编辑该会员</a>
                                            </td>
