...
(function(h, n) {
    ...
    function t(c, a) {
        ...
        b.onload = b.onerror = b.onreadystatechange = function() { / loaded | complete | undefined / .test(b.readyState) && (b.onload = b.onerror = b.onreadystatechange = null, b.parentNode.removeChild(b), b = void 0, a())
        };
    ...
    function y() {
        try {
            ...
            } else n = (new ActiveXObject("ShockwaveFlash.ShockwaveFlash")).GetVariable("$version"),
    ...
    function z() {
        var c = {};
        if ("undefined" != typeof _taadHolders && 0 < _taadHolders.length) for (var a = 0,
        b = _taadHolders,
        d = b.length; a < d; a++) c[b[a]] = c[b[a]] ? c[b[a]] + 1 : 1;
        var a = [],
        e;
    ...
    function u(c) {
        ...
        if (h.sid && !Ta[h.sid]) {
            ...
            g.src = a; (1 * !h.pf || h.hot.isValid) && B(a);
    ...
    function B(c) {
        ...
        d = a.pathname,
        e = function() {
            t(("https:" == document.location.protocol ? "https://": "http://") + "tajs.qq.com/ping_hotclick_min.js",
            function() {
                window.hotclick && (new hotclick(c)).watchClick()
            })
        };
        1 * h.pf ? (new RegExp(b)).test(h.hot.url) && e() : (a = h.sid, t("http://tcss.qq.com/heatmap/" + a % 100 + "/" + v(a) + ".js?random=" + +new Date,
        function() {
            var a;
    ...
    n.Ta = n.Ta || {};
    Ta.pgv = u; ! Ta.async && u(Ta.hack ? Ta.hack() : "")
})({
    sid: "",
    pf: "",
    hot: {
